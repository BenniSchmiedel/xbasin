...
class Power:
    ...
    def P_taug(self, tau_x, tau_y, eta, f, rho_0=1013.25, g=9.81, output_position=None, f_interpolation=False, **kwargs):
        """
    ...
    def P_down(self, tau_x, tau_y, eta, f, rho_0=1013.25, g=9.81, output_position=None, f_interpolation=True, **kwargs):
        """
    ...
    def P_lat(self, tau_x, tau_y, eta, f, rho_0=1013.25, g=9.81, output_position=None, f_interpolation=True, **kwargs):
        """
        Computes the downward flux into the geostrophic circulation.
